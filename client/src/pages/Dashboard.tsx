              ...
              {trappers.slice(0, 6).map((t, i) => (
                <Box
                  ...
                  sx={{
                    ...
                    '&:hover': { bgcolor: alpha('#ffffff', 0.016) },
                  }}
                >
                  <Box
                    sx={{
        ...
        <Grid item xs={12} md={7}>
          <Paper sx={{ border: `1px solid ${theme.palette.custom.border}` }}>
            ...
            <Table size="small">
              ...
              <TableBody>
                {feed.map((log) => (
                  <TableRow key={log.id} sx={{ '& .MuiTableCell-root': { borderColor: alpha(theme.palette.custom.border, 0.06), py: 0.9 }, '&:hover': { bgcolor: alpha('#ffffff', 0.016) } }}>
                    <TableCell>
